...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        name: 'pmTags',
        meta: { title: '标记Tags管理', icon: 'edit' }
      }, {
        path: 'activities',
        component: () => import('@/views/ProductsManagement/activities'),
        name: 'pmActivities',
        meta: { title: '活动Activities管理', icon: 'edit' }
      }
    ]
  },
  {
  ...
  },
  {
    path: '/operation',
    component: Layout,
    meta: { title: '运营活动管理', icon: 'operation' },
    children: [
      {
        path: 'incentiveList',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/emailTemplate',
        component: () => import('@/views/Global/emailTemplate/index'),
        meta: { title: 'emailTemplate', icon: 'email' },
        children: [
          {
            path: 'list',
            component: () => import('@/views/Global/emailTemplate/templateList'),
            name: 'EmailTemplateList',
            meta: { title: '邮件模板列表', icon: 'list' }
          },
          {
            path: 'details/:id(\\d+)',
            component: () => import('@/views/Global/emailTemplate/templateDetails'),
            name: 'details/:id(\\d+)',
